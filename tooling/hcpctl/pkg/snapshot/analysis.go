...
// WriteTestLogs writes the test's error and output logs to the test/ subdirectory
// of the output directory. This provides the analysis agent with the raw test
// output for inclusion in proof items.
